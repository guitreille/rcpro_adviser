...
class SimulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create simulation" do
    assert_difference("Simulation.count") do
      post simulations_url, params: { simulation: { annual_revenue: @simulation.annual_revenue, entreprise_no: @simulation.entreprise_no, legal_name: @simulation.legal_name, nacebel_codes: @simulation.nacebel_codes, natural_person: @simulation.natural_person } }
    end
  ...
  test "should update simulation" do
    patch simulation_url(@simulation), params: { simulation: { annual_revenue: @simulation.annual_revenue, entreprise_no: @simulation.entreprise_no, legal_name: @simulation.legal_name, nacebel_codes: @simulation.nacebel_codes, natural_person: @simulation.natural_person } }
